...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './proposal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROPOSAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROPOSAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROPOSAL actions', async () => {
      const arg = { id: 6085 };
    ...
    it('dispatches UPDATE_PROPOSAL actions', async () => {
      const arg = { id: 6085 };
    ...
    it('dispatches PARTIAL_UPDATE_PROPOSAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROPOSAL actions', async () => {
      const arg = 42666;
