...
import { deleteEntity, getEntity } from './proposal.reducer';
...
export const ProposalDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/proposal${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fypManagementSystemApp.proposal.delete.question">
        Are you sure you want to delete Proposal {proposalEntity.id}?
      </ModalBody>
      <ModalFooter>
