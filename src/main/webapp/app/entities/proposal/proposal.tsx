    ...
    <div>
      ...
      <div className="table-responsive">
        {proposalList && proposalList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('proposalAbstract')}>
                ...
                <th className="hand" onClick={sort('plagiarismScore')}>
            ...
            <tbody>
              {proposalList.map((proposal, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{proposal.proposalAbstract}</td>
                  <td>
                    {proposal.submissionDate ? <TextFormat type="date" value={proposal.submissionDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>{proposal.methodology}</td>
                  <td>{proposal.status}</td>
                  <td>{proposal.plagiarismScore}</td>
                  <td>{proposal.student ? proposal.student.login : ''}</td>
                  <td>{proposal.preferredSupervisor ? proposal.preferredSupervisor.login : ''}</td>
          ...
          !loading && <div className="alert alert-warning">No Proposals found</div>
        )}
      </div>
      {totalItems ? (
        <div className={proposalList && proposalList.length > 0 ? '' : 'd-none'}>
